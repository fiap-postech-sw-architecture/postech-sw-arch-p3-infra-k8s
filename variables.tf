...
variable "kubernetes_version" {
  description = "Versão do Kubernetes do EKS. Pin explícito (diferente do AKS da fase 2) porque o EKS cobra suporte estendido de versões antigas — manter numa versão em suporte padrão."
  type        = string
  default     = "1.31"
}
